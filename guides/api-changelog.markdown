---
title: 'API Changelog'
permalink: /guides/api-changelog/
group: versions
layout: post
color: blue
icon: fa fa-list
...
since the version 6 release for Metasys 14.1. It was released on October
6, 2025. See the [API documentation]({{ '/api/v6-15' | relative_url }}) for the
full specification.
...
- Equipment
  - Get equipment instances (`GET /equipment`) is replaced by "Get equipment
    tree".
  - Get equipment served by equipment (`GET /equipment/{equipmentId}/equipment`)
    is replaced by "Get served by equipment".
  - Get equipment serving a space (`GET /spaces/{spaceId}/equipment`) is
    replaced by "Get equipment serving a space"
    (`GET /spaces/{spaceId}/servingEquipment`)
- Spaces
  - Get spaces (`GET /spaces`) is replaced by "Get spaces tree".
  - Get space children (`GET /spaces/{spaceId}/spaces`) is replaced by "Get
    spaces subtree".
...
Metasys 14.1 shipped with API version 6, extended with non-breaking additions
since the initial version 6 release for Metasys 14.0. It was released on May
9, 2025. See the [API documentation]({{ '/api/v6-14-1' | relative_url }}) for
...
Metasys 14.0 shipped with the initial release of API version 6 on August
12, 2024. See the [API documentation]({{ '/api/v6' | relative_url }}) for the
full specification.
...
See the [API version 5 release documentation]({{ '/api/v5' | relative_url }})
released with Metasys 13.0.
...
See the [API version 4 release documentation]({{ '/api/v4' | relative_url }})
released with Metasys 12.0.
...
- Alarms
  - Get Alarms (Recommend using "List activities" instead)
- Audits
  - Get Audits (Recommend using "List activities" instead)
...
- Alarms
  ...
  - Get Alarms for an Object or a Network Device - **Breaking Changes**
    - These operations were modified in the same way as "Get Alarms"
...
- Audits
  ...
  - Discard an Audit - **Breaking Changes**
    ...
    - Path changed from `/audits/{id}/discard` to `/audits/{id}`
...
See the [API version 3 release documentation]({{ '/api/v3/' | relative_url }}),
released with Metasys 11.0.
...
See the [API version 2 release documentation]({{ '/api/v2/' | relative_url }}),
released with Metasys 10.1.
...
See the [API version 1 release documentation]({{ '/api/v1/' | relative_url }}),
the initial release of the Metasys REST API, released with Metasys 10.0.
